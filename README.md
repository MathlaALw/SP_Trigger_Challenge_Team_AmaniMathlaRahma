...
![DDL Trigger Flow](./image/how-ddl-trigger-works-over-database.png)
...
![Logon Trigger Flow](./image/logon-trigger-integration.png)
...
![DDL Trigger Output](./image/CheckExecutionOfDDLTrigger.png)
